...
function ImageUploadContainer() {
  ...
  const [boundingBoxImageUrl, setBoundingBoxImageUrl] = useState(null); // State for bounding box image
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
      ...
      setBoundingBoxImageUrl(data.image_download_url ? `http://127.0.0.1:5001${data.image_download_url}` : null);
